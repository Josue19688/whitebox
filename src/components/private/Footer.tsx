      ...
      <footer className="bg-gray-50 dark:bg-gray-800 antialiased">
        <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
            ...
            <div className="text-center">
                <img src={'/logo.png'} alt="" className="w-full sm:w-3/4 lg:max-w-sm mx-auto my-4 rounded-lg shadow-md object-cover" />
                <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 <a href="#" className="hover:underline">Josue™</a>. All Rights Reserved.
                </span>
